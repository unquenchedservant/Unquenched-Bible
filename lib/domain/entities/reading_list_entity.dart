...
class TodaysReadingsResult extends Equatable {
  final List<ReadingListEntity> readings;
  final bool isIndex;
  final int indexProgress;

  const TodaysReadingsResult({
  ...
  @override
  List<Object> get props => [readings, isIndex, indexProgress];
}
