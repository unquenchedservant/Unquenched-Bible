        ...
        children: [
          ...
          ListTile(
            ...
            ListTile(
              ...
              subtitle: const Text('Various ways to get support'),
              ...
              onTap: () {
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    title: const Text('Support Methods'),
                    content: Column(
                      mainAxisSize: MainAxisSize.min,
                      ...
                      children: [
                        ListTile(
                          ...
                          onTap: () async {
                            final uri = Uri.parse('mailto:support@unquenched.bible');
                            try {
                        ...
                        ListTile(
                          ...
                          onTap: () async {
                            final uri = Uri.parse('https://github.com/unquenchedservant/Unquenched-Bible/issues/new');
                            try {
                              await launchUrl(uri, mode: LaunchMode.externalApplication);
                              if (context.mounted) {
                                Navigator.of(context).pop();
                        ...
                        ListTile(
                          ...
                          onTap: () async {
                            final uri = Uri.parse('https://discord.gg/J4JPjkB7S8');
                            try {
                              await launchUrl(uri, mode: LaunchMode.externalApplication);
                              if (context.mounted) {
                                Navigator.of(context).pop();
