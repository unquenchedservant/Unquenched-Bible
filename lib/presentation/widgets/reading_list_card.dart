  ...
  Widget build(BuildContext context) {
    ...
    if (isMcheynePsalms) {
      ...
      if (is5PsalmsMode) {
        ...
        progressText = '${reading.currentChapter}/${reading.totalChapters}';
      }
    }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                if (isCompact)
                  Text(progressText, style: Theme.of(context).textTheme.bodySmall?.copyWith(fontSize: isCompact ? 11 : null)),
